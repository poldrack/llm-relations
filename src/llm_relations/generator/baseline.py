...
def generate_baseline(
    ...
    # perception_words[1] is left of perception_words[2]. Listed in a scrambled order.
    # The correct analog of m0 is perception_words[0] (same relational role).
    correct_analog = perception_words[0]

    # Build list_order: correct_analog at correct_slot_index, distractor at feature_distractor_slot.
    ...
    distractor = remaining[0]  # perception_words[1] is the feature distractor
    ...
    # Perception buttons:
    # correct_analog: target_color on top (structure-mapping preserved)
    # distractor: target_color somewhere not on top (feature lure)
    # third object: no target_color button
    perception_buttons: dict[str, list[tuple[str, str]]] = {
